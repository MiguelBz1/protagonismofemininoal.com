    ...
    const element2= document.getElementById('video-texto2');
    const element3 = document.getElementById('img-texto');

    const element4= document.getElementById('video-texto3');
    const element5 = document.getElementById('img-text2');

    const element6= document.getElementById('video-texto4');
    const element7 = document.getElementById('img-text3');

    const element8= document.getElementById('video-texto5');
    const element9 = document.getElementById('img-text5');

    const element10= document.getElementById('video-texto6');
    const element11 = document.getElementById('img-text4');
    ...
    if(window.screen.width < 1200) {
       ...
       x1.parentElement.removeChild(x1)
        ...
        element2.classList.remove('box-img1');
        element3.classList.remove('box-text1');
        x2.parentElement.removeChild(x2)

        element4.classList.remove('box-img2');
        element5.classList.remove('box-text2');
        x3.parentElement.removeChild(x3)

        element6.classList.remove('box-img3');
        element7.classList.remove('box-text3');
        x4.parentElement.removeChild(x4)
        
        element8.classList.remove('box-img4');
        element9.classList.remove('box-text4');
        x5.parentElement.removeChild(x5)
        
        element10.classList.remove('box-img5');
        element11.classList.remove('box-text5');
        x6.parentElement.removeChild(x6)
